...
for /f "delims=" %%i in ('docker run -d --name "%CONTAINER_NAME%" -p 8001:8000 -p 9001:9000 -p 9091:9090 -p 3001:3000 -p 8100:8099 -p 5433:5432 -p 4201:4200 -v storage_volume:/local_storage "%DOCKER_IMAGE%"') do set "CONTAINER_ID=%%i"
