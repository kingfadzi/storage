...
start_container() {
  ...
  CONTAINER_ID=$(docker run -d --name "$CONTAINER_NAME" -p 8000:8000 -p 9000:9000 -p 9090:9090 -p 3000:3000 -p 8099:8099 -p 5433:5432 -v storage_volume:/local_storage "$DOCKER_IMAGE")
  wait_for_container
}
